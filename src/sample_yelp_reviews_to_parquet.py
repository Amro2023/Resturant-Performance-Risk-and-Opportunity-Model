...
sampled_output_path = project_root / "data" / "processed" / "yelp_us_restaurant_reviews_sampled_100_per_business.parquet"
...
print("Sampling reviews into Parquet...")
...
df_sampled.to_parquet(sampled_output_path, index=False)
